...
function askQuestion() {
 ...
 candidateAnswer = input.question (question)
  ...
  console.log(`Your Answer: ${candidateAnswer} \nCorrect Answer: ${correctAnswer}`)}
   else { console.log(`Your Answer: ${candidateAnswer} \nCorrect Answer: ${correctAnswer}`)} 
...
let numOfCorrectA = 0
let numOfQuizQ = candidateAnswers.length
...
if (winWin <= "60") console.log (`>>> Overall Grade: ${winWin} <<<`)
  else {
    console.log(`${winWin} >>> Status: FAILED <<<`)
  }
